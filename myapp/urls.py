...
urlpatterns = [
   ...
   path('seller-order/',views.seller_index,name='seller-index'),
   ...
   path('seller-vegetables-product/',views.seller_vegetables_product, name='seller-vegetables-product'),
   path('vegetables-product/',views.vegetables_product, name='vegetables-product'),
   path('seller-fruits-product/',views.seller_fruits_product, name='seller-fruits-product'),
   path('fruits-product/',views.fruits_product, name='fruits-product'),
   path('seller-all-product/',views.seller_all_product, name='seller-all-product'),
